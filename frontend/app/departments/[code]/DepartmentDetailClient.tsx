...
export const DEPT_FALLBACK_DATA: Record<string, any> = {
  cse: {
    code: 'CSE',
  ...
  csd: {
    ...
    description:
      'Specialized in big data analytics, statistical modeling, data visualization, predictive modeling, and business intelligence systems for modern enterprises.',
    labs: [
      { name: 'Big Data & Hadoop Cluster Lab', desc: 'Distributed computing infrastructure for parallel processing and MapReduce.' },
      { name: 'Statistical Computing & Visualization Lab', desc: 'R, Python, Tableau, and PowerBI environments.' },
    ],
    faculty: [
      { name: 'Dr. M. S. Rao', role: 'Professor & HOD', qual: 'Ph.D. in Data Analytics', exp: '14+ Years' },
      { name: 'Mrs. P. Vani', role: 'Assistant Professor', qual: 'M.Tech in CSE', exp: '7+ Years' },
    ],
    curriculum_highlights: [
  ...
  eee: {
    ...
    established: 2007,
    intake: 60,
    accredited: 'AICTE Approved & NAAC Accredited',
    hod: 'Dr. K. Srinivas',
    hod_email: 'hodeee@srecnandyal.edu.in',
    description:
      'Dedicated to renewable energy integration, power electronic drives, microgrid systems, and high-voltage transmission modernizations.',
    labs: [
      { name: 'Power Systems & Simulation Lab', desc: 'MATLAB/Simulink and PSCAD transmission line analysis.' },
      { name: 'Electrical Machines & Control Systems Lab', desc: 'AC/DC motor benches with dynamometer loading sets.' },
    ],
    faculty: [
      { name: 'Dr. K. Srinivas', role: 'Professor & HOD', qual: 'Ph.D. in Power Electronics', exp: '17+ Years' },
      { name: 'Mr. C. Prasad', role: 'Associate Professor', qual: 'M.Tech in Power Systems', exp: '9+ Years' },
    ],
    curriculum_highlights: [
      'Power Electronics & Electric Vehicle Drives',
      'Renewable Energy Systems & Solar PV Design',
      'Control Systems Engineering',
      'Smart Grid Technologies & IoT Metering',
    ],
  },
  mech: {
    code: 'MECH',
    ...
    accredited: 'AICTE Approved & NAAC Accredited',
    hod: 'Dr. V. Prasad',
    hod_email: 'hodmech@srecnandyal.edu.in',
    description:
      'Emphasizing advanced computer-aided design (CAD/CAM), thermal power engineering, manufacturing automation, and industrial robotics.',
    labs: [
      { name: 'CAD/CAM Computer Lab', desc: 'SolidWorks, AutoCAD, and ANSYS engineering simulation workstations.' },
      { name: 'Thermal Engineering & Heat Transfer Lab', desc: 'Multi-cylinder IC engines with computerized test benches.' },
    ],
    faculty: [
      { name: 'Dr. V. Prasad', role: 'Professor & HOD', qual: 'Ph.D. in Thermal Sciences', exp: '15+ Years' },
    ],
    curriculum_highlights: [
      'Engineering Mechanics & Strength of Materials',
      'Finite Element Analysis & Computer Aided Simulation',
  ...
  civil: {
    ...
    accredited: 'AICTE Approved & NAAC Accredited',
    hod: 'Dr. S. K. Reddy',
    hod_email: 'hodcivil@srecnandyal.edu.in',
    description:
      'Committed to sustainable structural engineering, geotechnical investigations, water resource management, and GIS urban surveying.',
    labs: [
      { name: 'Structural Engineering & Concrete Technology Lab', desc: 'Compression testing machines and flexural test apparatus.' },
      { name: 'Surveying & Total Station Lab', desc: 'Digital total stations, GPS equipment, and GIS software suites.' },
    ],
    faculty: [
      { name: 'Dr. S. K. Reddy', role: 'Professor & HOD', qual: 'Ph.D. in Structural Engineering', exp: '16+ Years' },
    ],
    curriculum_highlights: [
      'Structural Analysis & Design of RC Structures',
      'Soil Mechanics & Foundation Engineering',
      'Environmental Engineering & Water Supply Systems',
  ...
  mba: {
    ...
    established: 2009,
    intake: 120,
    accredited: 'AICTE Approved & Autonomous',
    hod: 'Dr. N. V. Reddy',
    hod_email: 'hodmba@srecnandyal.edu.in',
    description:
      'Fostering entrepreneurial mindsets, financial acumen, strategic marketing leadership, and modern business analytics.',
    labs: [
      { name: 'Business Simulation & Finance Lab', desc: 'Stock market simulation software and financial reporting suites.' },
    ],
    faculty: [
      { name: 'Dr. N. V. Reddy', role: 'Professor & HOD', qual: 'Ph.D. in Management', exp: '19+ Years' },
    ],
    curriculum_highlights: [
  ...
  mca: {
    ...
    description:
      'Advanced post-graduate program specializing in cloud applications, modern enterprise frameworks, cybersecurity, and mobile engineering.',
    labs: [
      { name: 'Enterprise Computing & Web Technologies Lab', desc: 'Spring Boot, Node.js, and containerized microservices labs.' },
    ],
    faculty: [
      { name: 'Dr. A. Sudhakar', role: 'Professor & HOD', qual: 'Ph.D. in Computer Science', exp: '14+ Years' },
    ],
    curriculum_highlights: [
      'Enterprise Application Development (Java & Spring Boot)',
      'Cloud Architecture & DevOps Pipelines',
      'Network Security & Cryptography',
      'Mobile Application Engineering (Flutter & React Native)',
    ],
  },
};

export default function DepartmentDetailContent({ code }: { code: string }) {
  const [activeTab, setActiveTab] = useState<'overview' | 'labs' | 'faculty' | 'curriculum'>('overview');

  const normalized = code.toLowerCase();
  const dept = DEPT_FALLBACK_DATA[normalized] || DEPT_FALLBACK_DATA['cse'];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="flex border-b border-slate-200 gap-2 overflow-x-auto pb-1">
          {[
            ...
            { key: 'labs', label: `Laboratories (${dept.labs?.length || 0})` },
            { key: 'faculty', label: `Faculty Roster (${dept.faculty?.length || 0})` },
