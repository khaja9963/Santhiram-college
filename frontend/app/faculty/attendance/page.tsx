...
import {
  CalendarCheck, CheckCircle2, Save,
  FileSpreadsheet, Download, Lock, Users, AlertTriangle
} from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          {/* Link to All Candidates View */}
          <Link
            href="/faculty/candidates"
            className="flex items-center gap-1.5 bg-blue-50 hover:bg-blue-100 text-blue-800 border border-blue-200 text-xs font-bold px-3.5 py-2.5 rounded-xl shadow-xs transition-colors shrink-0"
            title="View All Candidates Attendance Percentages & Analytics"
          >
